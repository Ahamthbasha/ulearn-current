    ...
    <Routes>
      ...
      <Route element={<PrivateRoute />}>
        <Route element={<InstructorSidebarLayout />}>
          ...
          />
          <Route
            path="course/:courseId/modules/add"
            element={<AddModulePage />}
          />
          <Route
            path="course/:courseId/modules/:moduleId/edit"
          ...
          />
          <Route
            path="modules/:moduleId/chapters/add"
            element={<AddChapterPage />}
          />
          <Route
            path="modules/:moduleId/chapters/:chapterId/edit"
            element={<EditChapterPage />}
          />

          {/* quizManage */}
          <Route
            path="course/:courseId/modules/:moduleId/quiz"
            element={<QuizManagementPage />}
          />
          <Route
            path="course/:courseId/modules/:moduleId/quiz/add"
            element={<AddQuizPage />}
          />
          <Route
            path="course/:courseId/modules/:moduleId/quiz/edit/:quizId"
          ...
          <Route
            path="editCourseOffer/:offerId"
            element={<EditInstructorCourseOfferPage />}
          />
