...
export const createWalletRechargeOrder = async (data: {
  ...
  try {
    const response = await API.post(UserRouterEndpoints.userCreateOrderForWalletCredit, data);
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const verifyPayment = async (data: {
  ...
  try {
    const response = await API.post(UserRouterEndpoints.userVerifyPayment, data);
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const walletTransactionHistory = async (page: number = 1, limit: number = 5) => {
  try {
...
export const orderDetail = async(orderId:string)=>{
  try {
    const response = await API.get(`${UserRouterEndpoints.userGetOrderDetail}/${orderId}`)
    return response.data
  } catch (error) {
   throw error 
  }
