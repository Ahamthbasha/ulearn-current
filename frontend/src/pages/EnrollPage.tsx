        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 px-4 py-10">
          ...
          <div className="flex flex-col items-center space-y-4 text-center max-w-xs">
            ...
            <button
              ...
              className="bg-blue-600 text-white rounded px-4 py-2 font-bold hover:bg-blue-700"
            >
              Enroll as Student
            </button>
            <p className="text-sm text-gray-400">
              Enroll as a student to explore courses, gain knowledge and receive
              assistance.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4 text-center max-w-xs">
            ...
            <p className="text-sm text-gray-400">
              Enroll as a instructor to guide learners, publish courses, and
              offer slots for sessions.
            </p>
          </div>
        </div>
      </main>
