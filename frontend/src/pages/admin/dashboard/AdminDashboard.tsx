...
const AdminDashboard = () => {
  ...
  const handleExport = async (reportType: "course" | "membership", format: "excel" | "pdf") => {
    try {
      ...
      setError(`Failed to export ${reportType} report as ${format.toUpperCase()}`);
    } finally {
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex space-x-2">
              <button
                ...
                disabled={exportLoading || (activeTab === "course" ? courseReport.length === 0 : membershipReport.length === 0)}
