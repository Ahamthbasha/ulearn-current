              ...
              <table className="w-full border rounded shadow-sm">
                <thead className="bg-gray-100">
                  <tr>
                    ...
                    <th className="px-2 sm:px-4 py-1 sm:py-2 text-left text-xs sm:text-sm">Learning Paths</th>
                    ...
                    <tr key={idx} className="border-t">
                      ...
                      <td className="px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm">
                        <ul className="list-disc list-inside">
                          {item.standaloneCourse.map((course, courseIdx) => (
                            <li key={courseIdx} className="mb-1">
                              <span className="font-medium">{course.courseName}</span>
                              <br />
                              Final Price: ₹{course.standAloneCourseTotalPrice.toFixed(2)}
                            </li>
                          ))}
                        </ul>
                      </td>
                      <td className="px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm">
                        <ul className="list-disc list-inside">
                          {item.learningPath.map((lp, lpIdx) => (
                            <li key={lpIdx} className="mb-1">
                              <span className="font-medium">{lp.learningPathName}</span>
                              <br />
                              Final Price: ₹{lp.learningPathTotalPrice.toFixed(2)}
                            </li>
                          ))}
                        </ul>
                      </td>
                      <td className="px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm">
                        ...
                        Discount: ₹{item.couponDiscountAmount.toFixed(2)}
                      </td>
                      <td className="px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm">₹{item.totalOrderAmount.toFixed(2)}</td>
                      <td className="px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm text-green-700">₹{item.instructorRevenue.toFixed(2)}</td>
                    </tr>
                  ))}
                </tbody>
                <tfoot>
                  <tr className="bg-gray-100 font-semibold">
                    <td colSpan={6} className="px-2 sm:px-4 py-1 sm:py-2 text-right text-xs sm:text-sm">
