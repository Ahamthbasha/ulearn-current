...
export function mapCourseToInstructorDTO(
  course: ICourse & { category?: { categoryName: string } },
): InstructorCourseDTO {
  return {
...
export function mapCoursesToInstructorDTOs(
  courses: (ICourse & { category?: { categoryName: string } })[],
): InstructorCourseDTO[] {
