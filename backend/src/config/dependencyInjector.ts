...
const studentCourseOfferRepo: IStudentCourseOfferRepository =
  new StudentCourseOfferRepository();
...
const adminCourseOfferService: IAdminCourseOfferService =
  new AdminCourseOfferService(adminCourseOfferRepo);
