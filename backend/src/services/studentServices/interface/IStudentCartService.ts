...
export interface IStudentCartService {
  ...
  addToCart(userId: Types.ObjectId, courseId: Types.ObjectId): Promise<CartCourseDTO[] | null>;
  removeFromCart(userId: Types.ObjectId, courseId: Types.ObjectId): Promise<CartCourseDTO[] | null>;
