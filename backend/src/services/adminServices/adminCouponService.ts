...
//     // Parse the expiry date (frontend sends with IST timezone offset)
//     const expiryDate = new Date(couponData.expiryDate);
...
//     // Set expiry date to start of day in UTC for comparison
//     const expiryDateComparison = new Date(expiryDate);
//     expiryDateComparison.setUTCHours(0, 0, 0, 0);
...
//     let newExpiryDate: Date | undefined;
//     if (couponData.expiryDate) {
//       // Parse the new expiry date (frontend sends with IST timezone offset)
//       newExpiryDate = new Date(couponData.expiryDate);
      
//       // Get existing expiry date (start of day in UTC)
//       const existingDate = new Date(existingCoupon.expiryDate);
//       existingDate.setUTCHours(0, 0, 0, 0);
      
//       // Set new expiry date to start of day in UTC for comparison
//       const newExpiryDateComparison = new Date(newExpiryDate);
//       newExpiryDateComparison.setUTCHours(0, 0, 0, 0);
...
//       if (newExpiryDateComparison.getTime() !== existingDate.getTime() && newExpiryDateComparison < today) {
//         throw new Error("Expiry date must be in the future");
//       }
//     }
