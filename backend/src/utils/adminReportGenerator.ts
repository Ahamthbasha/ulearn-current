...
// import { IAdminCourseSalesReportItemFlattened,IAdminMembershipReportItem } from "../types/dashboardTypes";

// export async function generateCourseSalesExcelReport(
//   data: IAdminCourseSalesReportItemFlattened[],
...
//     "Admin Share",
//   ];
//   const colWidths = [100, 60, 130, 100, 80, 80]; // total ~558
...
//       item.courseName,
//       item.instructorName,
//       `Rs. ${item.coursePrice.toFixed(2)}`,
//       `Rs. ${item.adminShare.toFixed(2)}`,
//     ];
