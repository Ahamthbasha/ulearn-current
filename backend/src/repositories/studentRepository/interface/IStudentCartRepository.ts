...
export interface IStudentCartRepository {
  ...
  addLearningPath(userId: Types.ObjectId, learningPathId: Types.ObjectId): Promise<ICart>;
  removeCourse(userId: Types.ObjectId, courseId: Types.ObjectId): Promise<ICart | null>;
  removeLearningPath(userId: Types.ObjectId, learningPathId: Types.ObjectId): Promise<ICart | null>;
