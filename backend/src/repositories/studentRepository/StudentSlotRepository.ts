...
// src/repositories/studentRepository/StudentSlotRepository.ts
import { IStudentSlotRepository } from "./interface/IStudentSlotRepository";
import { ISlot } from "../../models/slotModel";
import slotModel from "../../models/slotModel";
import { GenericRepository } from "../genericRepository";
  ...
  implements IStudentSlotRepository
{
  ...
  async getAvailableSlotsByInstructorId(
    ...
    // Show slots for next 3 months (adjust as needed)
    ...
    let query = this.model
      ...
      .sort({ startTime: 1 })
      .lean(); // lean() for better performance since we only read
