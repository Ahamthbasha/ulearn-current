...
import {IMembershipPlan, MembershipPlanModel } from "../../models/membershipPlanModel";
import { GenericRepository } from "../genericRepository";

export class InstructorMembershipRepository extends GenericRepository<IMembershipPlan>  implements IInstructorMembershipRepository {
    constructor(){
