...
export interface IAdminCouponRepo {
  ...
  updateCoupon(id: Types.ObjectId, couponData: Partial<ICoupon>): Promise<ICoupon | null>;
  deleteCoupon(id: Types.ObjectId): Promise<boolean>;
  toggleCouponStatus(id: Types.ObjectId, status: boolean): Promise<ICoupon | null>;
}