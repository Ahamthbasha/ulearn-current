...
export class AdminDashboardRepository implements IAdminDashboardRepository {
  ...
  constructor(instructorRepo: IInstructorRepository,courseRepo: CourseRepository,orderRepo: OrderRepository,membershipOrderRepo: InstructorMembershipOrder) {
  ...
  async getCourseSalesReportFiltered(filter: {
    ...
    const totalItems = await this._orderRepo.aggregate([
    ...
    const items = await this._orderRepo.aggregate<IAdminCourseSalesReportItem>(aggregation);
  ...
  async getMembershipSalesReportFiltered(filter: {
    ...
    const totalItems = await this._membershipOrderRepo.aggregate([
    ...
    const items = await this._membershipOrderRepo.aggregate<IAdminMembershipReportItem>(aggregation);
