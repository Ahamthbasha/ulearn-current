...
router.get('/wallet',authenticateToken,isStudent,studentWalletController.getWallet.bind(studentWalletController))

router.post('/wallet/credit',authenticateToken,isStudent,studentWalletController.creditWallet.bind(studentWalletController))

router.post('/wallet/debit',authenticateToken,isStudent,studentWalletController.debitWallet.bind(studentWalletController))

router.get('/wallet/transactions', authenticateToken,isStudent, studentWalletController.getPaginatedTransactions.bind(studentWalletController));

//wallet payment related routes

router.post('/wallet/payment/createOrder',authenticateToken,isStudent,studentWalletPaymentController.createOrder.bind(studentWalletPaymentController))

router.post('/wallet/payment/verify',authenticateToken,isStudent,studentWalletPaymentController.verifyPayment.bind(studentWalletPaymentController))

//////////////////////order history///////////////////////////////////

router.get('/orders',authenticateToken,isStudent,studentOrderController.getOrderHistory.bind(studentOrderController))

router.get('/orders/:orderId',authenticateToken,isStudent,studentOrderController.getOrderDetails.bind(studentOrderController))

router.get('/orders/:orderId/invoice',authenticateToken,isStudent,studentOrderController.downloadInvoice.bind(studentOrderController))
